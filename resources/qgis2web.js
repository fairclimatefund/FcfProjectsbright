...
map.getView().fit([-20037507.229594, -20048966.100000, 20037507.229594, 20048966.100000], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">FairClimateFund Project Locations </h2>';
        return titleElement;
    })(),
